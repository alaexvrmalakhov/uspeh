...
drupal_add_js('sites/all/themes/conch/js/tables.js');
...
// Add font-awesome.min.css file
drupal_add_css($theme_path . '/css/font-awesome.min.css', 'theme');  

// Add price-table-style.css file
drupal_add_css($theme_path . '/css/price-table-style.css', 'theme');

// Add bearings.css file 
drupal_add_css($theme_path . '/css/custom_styles.css', 'theme'); 
